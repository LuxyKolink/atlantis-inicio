...
def get_pais_repository(db: Session = Depends(get_sqlite_db)) -> PaisRepository:
...
def get_pais_service(pais_repository: PaisRepository = Depends(get_pais_repository)) -> PaisService:
